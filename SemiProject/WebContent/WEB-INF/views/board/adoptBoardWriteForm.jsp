				...
				<form id="main-contact-form" class="contact-form" name="contact-form" method="post"  action="<%= request.getContextPath() %>/insert.bo">
                    <div> <!-- class="col-sm-6" -->
                        <div class="form-group">
                            <label>제목 *</label>
                            <input type="text" name="title" class="form-control" required="required" placeholder="제목을 입력해주세요.(ex : 시츄 입양 원합니다.)">
                        </div>
                        <div class="form-group">
                            <label>내용 *</label>
                            <textarea name="content" id="content" required="required" class="form-control" rows="8" placeholder="내용을 입력해주세요(나이, 양육경험, 선호품종 등.)"></textarea>
                        </div>
