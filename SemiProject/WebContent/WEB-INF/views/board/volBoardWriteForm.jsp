	...
	<section id="contact-page">
		<div class="container">
			...
			<div class="row contact-wrap"> 
				...
				<form id="main-contact-form" class="contact-form" name="contact-form" method="post"  action="<%= request.getContextPath() %>/volInsert.bo">
                    <div> <!-- class="col-sm-6" -->
                        <div class="form-group">
                            <label>제목 *</label>
                            <input type="text" name="title" class="form-control" required="required" placeholder="제목을 입력해주세요(ex : (보호소 / 동물구조 / 물품후원) 신청합니다.)">
                        </div>
                        <div class="form-group">
                            <label>내용 *</label>
                            <textarea name="content" id="content" required="required" class="form-control" rows="8" placeholder="내용을 입력해주세요(나이, 봉사경험, 가능일정, 거주지 등.)"></textarea>
                        </div>
