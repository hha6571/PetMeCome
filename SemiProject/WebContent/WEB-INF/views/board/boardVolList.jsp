...
<body class="homepage">
    ...
    <section id="testimonial1">
        <div class="container">
            <div class="center fadeInDown">
                <h2>봉사활동 신청</h2>
                <p class="lead">유기 동물들이 보호소에서 행복하게 지낼수 있도록 도와주세요..</p>
            </div>
            </div>
      ...
      <tr>
        ...
        <th style="text-align: center">작성자</th>
   		...
   		<% if(list.isEmpty()){ %>
  			...
  			<a onclick="location.href='<%= request.getContextPath() %>/volWriteBoardForm.bo'" class="btn btn-primary pull-right" style="background:#4895ef">봉사활동 신청</a>
