	...
	<section id="contact-page">
		<div class="container">
			<div class="large-title text-center">        
                <h2 style = "font-size: 28px;">게시판 수정</h2>
				...
				<input type="hidden" name="bId" value="<%= b.getBoardNo() %>">
	                 <div> <!-- class="col-sm-6" -->
                        <div class="form-group">
                            <label>제목 *</label>
                            <input type="text" name="title" class="form-control" required="required" value="<%= b.getBoardTitle() %>">
                        </div>
                        <div class="form-group">
                            <label>내용 *</label>
                        ...
                        <div class="form-group" align="center">
                            ...
                            <input type="button" class="btn btn-primary btn-lg" required="required" style="width: 100px" id="cancelBtn" onclick="location.href='<%= request.getContextPath() %> menubar.jsp'" value="취소">
