            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="widget">
                        ...
                        <ul>
                        <li>
                        <a id="modalshow">개인정보처리방침</a>
							    <div class="modalBg">
							      <div class="modalwindow">
							        <div class="modalpopup">
							        <h1>개인정보처리방침</h1>
<p>
 회사명(이하 ‘팻미컴’라 한다)는 개인정보 보호법 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립․공개합니다.<br>
<br>
제1조 (개인정보의 처리목적)<br>
...
<br>
2. 재화 또는 서비스 제공<br>
물품배송, 서비스 제공, 계약서․청구서 발송, 콘텐츠 제공, 이벤트 안내, 맞춤서비스 제공, 본인인증, 연령인증, 요금결제․정산, 채권추심 등을 목적으로 개인정보를 처리합니다.<br>
<br>
3. 고충처리<br>
...
▶ 경찰청 사이버안전국 : 182 <a href="http://cyberbureau.police.go.kr">(http://cyberbureau.police.go.kr)</a><br>
<br><br>
...
<p>제1조 목적 <br>
 <br>
본 이용약관은 “팻미컴" 서비스의 이용조건과 운영에 관한 제반사항 규정을 목적으로 합니다.<br>
<br>
제2조 용어의 정의<br>
<br>
...
부칙<br>
<br>
이 약관은 <사이트 개설일> 부터 시행합니다.</p>
							          <button id="modalclose2">닫기</button>
							        </div>
							        </div>
							      </div>
						</li>
                            <li>운영시간 : 연중무휴 11:00 ~ 20:00</li>
                            </ul>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
    ...
    <footer id="footer" class="midnight-blue">
 	...
 	<div id="topbar"> 
 	<a href="#header"><img src="images/top.png" title="위로 가기"></a>
</div>
    <!--/#footer-->
